module ApplicationHelper
	...
	def query_top_tracks(token_code)
		token_response = HTTParty.post("https://accounts.spotify.com/api/token", body: { grant_type:"authorization_code", code: token_code, redirect_uri: "http://localhost:3000/welcome/landing", client_id: "e638e9fda4624061ae4662923427484e", client_secret: "b6259502255f40b396e91711ffbf0907" }, header: { authorization: "code" })
